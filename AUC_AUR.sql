...
create table SRAA_SAND.NOVA_ACTL_YTD
	(FIS_YR_NBR	SMALLINT,
	 FIS_QTR_NBR SMALLINT, 
	 FIS_QTR_DESC VARCHAR(200),
	 FIS_YR_NBR_MO	SMALLINT, 
	 FIS_MO_NBR	BYTEINT, 
	 FIS_MO_DESC VARCHAR(30), 
	 BRD_KEY	INTEGER, 
	 BRD_NM VARCHAR(50) CHARACTER SET LATIN NOT CASESPECIFIC,
	 MKT_KEY	INTEGER, 
	 MKT_DESC VARCHAR(50) CHARACTER SET LATIN NOT CASESPECIFIC,
	 CHNL_KEY	INTEGER, 
     CHNL_NM VARCHAR(50) CHARACTER SET LATIN NOT CASESPECIFIC,
	 "Cost Vendor Rects"	FLOAT, 
	"Unit Vendor Rects"	FLOAT, 
	"Rev Sales Amt" FLOAT,
	"Rev Sales Units" FLOAT,
	"Cost Sales Amt"	FLOAT) 
	primary index (FIS_YR_NBR_MO, FIS_MO_NBR, MKT_KEY, CHNL_KEY, BRD_KEY);
	
 INSERT INTO SRAA_SAND.NOVA_ACTL_YTD 
 select	
